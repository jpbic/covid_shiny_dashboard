...
theme_custom <- shinyDashboardThemeDIY(
  ...
  ,bodyBackColor = "rgb(224,224,224)"
  
  ### header
  ,logoBackColor = "rgb(44, 62, 80)"
  
  ,headerButtonBackColor = "rgb(44, 62, 80)"
  ,headerButtonIconColor = "rgb(240, 240, 240)"
  ,headerButtonBackColorHover = "rgb(27, 38, 49)"
  ,headerButtonIconColorHover = "rgb(240, 240, 240)"
  ...
  ,sidebarTabBackColorSelected = "rgb(240,240,240)"
  ,sidebarTabTextColorSelected = "rgb(0,0,0)"
  ,sidebarTabRadiusSelected = "0px"
  
  ,sidebarTabBackColorHover = "rgb(244, 218, 196)"
